...
@RestController
public class ContribuintesLoteNotificacaoApiController implements ContribuintesLoteNotificacaoApi {

    private static final Logger log = LoggerFactory.getLogger(ContribuintesLoteNotificacaoApiController.class);
    ...
    public ContribuintesLoteNotificacaoApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<LoteGrid>> consultarPorFiltroContribLoteNotificacao(@Parameter(in = ParameterIn.HEADER, description = "data do período inicial" ,required=true,schema=@Schema()) @RequestHeader(value="dataInicial", required=true) String dataInicial
